...
//  DriverEntry.
// =============================================================================
static NTSTATUS ModernInjectorInitialize(PDRIVER_OBJECT driverObject, PUNICODE_STRING registryPath) {
...
extern "C" NTSTATUS DriverEntry(PDRIVER_OBJECT driverObject, PUNICODE_STRING registryPath) {
    if (driverObject) {
        return ModernInjectorInitialize(driverObject, registryPath);
    }

    UNICODE_STRING driverName;
    RtlInitUnicodeString(&driverName, L"\\Driver\\ModernInjector");
    return IoCreateDriver(&driverName, ModernInjectorInitialize);
}