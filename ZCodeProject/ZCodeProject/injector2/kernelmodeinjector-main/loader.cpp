...
//
//  Prerequisites:
//     - The driver service "ModernInjector" must be installed and running
//       (see run.bat / README). Otherwise CreateFileW fails with error 2/5.
// =============================================================================
int main(int argc, char** argv) {
    ...
    if (hDevice == INVALID_HANDLE_VALUE) {
        ...
        std::cerr << "Is the 'ModernInjector' service installed and started?" << std::endl;
        return 1;
    }
